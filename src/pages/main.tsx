...
function Main() {
    ...
    async function getLocation() {
        ...
        fetch(`https://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&appid=a1215692d81f82a8f734b4e483c2af15&units=metric`).then((res :any) => res.json()).then((json :any) => {
            console.log(json)
            setCity(json.name)
